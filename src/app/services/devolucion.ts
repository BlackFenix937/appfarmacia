...
export class Devolucion {
  ...
  url: string = `${environment.apiUrl}devolucions`;
  ...
  detalle(dev_id: number | string | null = null, extra: string = ''): Observable<any> {
    const url = `${this.url}/` + dev_id + extra;
    return new Observable(observer => {
      axios.get(url, {
        withCredentials: true,
        headers: this.headers
  ...
  actualizar(dev_id: number, devolucion: any): Observable<any> {
